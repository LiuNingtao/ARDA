...
parser.add_argument('--data_path',
                    type=str,
                    default='/media/gsp/48cfceb8-8b77-4141-bba7-da05abd58d95/2019/lnt/project/ToothAge/DataSet/AgeDataSetSingleSkull/DataSetFiltered4-50')
parser.add_argument('--heat_dir',
                    type=str,
                    default='/media/gsp/LNT/DataSet/Tooth/heat-map/heat_map_part_vertebra_4-40/npy/')
parser.add_argument('--result_path', type=str, default=os.path.join(curr_dir, './result/result0119_vertebra_heat'))
parser.add_argument('--load_path', type=str, default=os.path.join(curr_dir, './result/result0119_vertebra_heat'))
...
parser.add_argument('--drop_out', type=float, default=0.55)
...
parser.add_argument('--desc', type=str, default='vertebra + heat')
