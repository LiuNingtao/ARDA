...
from dataset_part_heat import DataSetAgeFusion as MyDataSet
...
parser.add_argument('--heat_dir',
                    type=str,
                    default='/media/gsp/LNT/DataSet/Tooth/heat-map/heat_map_part_vertebra_4-40/npy_simple/')
...
parser.add_argument('--result_path', type=str, default=os.path.join(curr_dir, './result/result0124_vertebra_heat'))
parser.add_argument('--load_path', type=str, default=os.path.join(curr_dir, './result/result0124_vertebra_heat'))
...
def entrance():
    ...
    train_dataset = MyDataSet(train_df, args.data_dir, args.heat_dir, transform_skull, transform_mask, mode='train')
    test_dataset = MyDataSet(test_df, args.data_dir, args.heat_dir, transform_skull, transform_mask, mode='test')
    val_dataset = MyDataSet(val_df, args.data_dir, args.heat_dir, transform_skull, transform_mask, mode='val')
