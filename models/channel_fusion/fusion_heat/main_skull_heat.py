...
from dataset_skull_heat import DataSetAgeFusion as MyDataSet
...
parser.add_argument('--result_path', type=str, default='/media/gsp/48cfceb8-8b77-4141-bba7-da05abd58d95/2019/lnt/project/ToothAge/models/channel_fusion/result/result1017')
parser.add_argument('--load_path', type=str, default='/media/gsp/48cfceb8-8b77-4141-bba7-da05abd58d95/2019/lnt/project/ToothAge/models/channel_fusion/result/result1017')
...
parser.add_argument('--desc', type=str, default='单个skull，小于18')
...
def entrance():
    ...
    train_dataset = MyDataSet(train_df, args.heat_dir, None, mode='train')
    test_dataset = MyDataSet(test_df, args.heat_dir, None, mode='test')
    val_dataset = MyDataSet(val_df, args.heat_dir, None, mode='val')
