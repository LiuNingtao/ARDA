...
from mobile_net_v3 import mobilenetv3_large, mobilenetv3_small
from efficientnet_pytorch import EfficientNet
from dataset_mobile_net import DataSetAgeFusion as MyDataSet
...
parser.add_argument('--result_path', type=str, default=os.path.join(cur_dir, './result/mobile_large_1203'))
parser.add_argument('--load_path', type=str, default=os.path.join(cur_dir, './result/mobile_large_1203'))
...
parser.add_argument('--desc', type=str, default='单个skull,mobile small')
