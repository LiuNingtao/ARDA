...
from dataset_resnet import DataSetAgeFusion as MyDataSet
...
parser.add_argument('--result_path', type=str, default=os.path.join(cur_dir, './result/res18_1120'))
parser.add_argument('--load_path', type=str, default=os.path.join(cur_dir, './result/res18_1120'))
...
def entrance():
    ...
    model = resnet152(pretrained=args.is_pertrain)
