...
from dataset_densenet import DataSetAgeFusion as MyDataSet
...
parser.add_argument('--result_path', type=str, default=os.path.join(cur_dir, './result/densenet161_1201'))
parser.add_argument('--load_path', type=str, default=os.path.join(cur_dir, './result/densenet161_1201'))
