...
parser.add_argument('--result_path', type=str, default='./result_0817')
parser.add_argument('--model_path', type=str, default='./result_0811')
...
def train_model(model,
                ...
                init_epoch=16):
    if args.result_path:
        path = os.path.join(args.model_path, 'model_save', 'model_train_latest.pth')
